 ...
 *
 */
public class JFrameCadastroAdmin extends javax.swing.JFrame {
    ...
    /**
     * Creates new form JFrameCadastroAdmin
     */
    public JFrameCadastroAdmin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        JLabelCadastro.setText("Cadastrar Administrador");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(JLabelCadastro, javax.swing.GroupLayout.PREFERRED_SIZE, 550, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void JButtonConcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JButtonConcluirActionPerformed
        ...
        if (JTextFieldUsuario.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Deve ser digitado um nome de usuário!", "Aviso!", JOptionPane.ERROR_MESSAGE, iconeAlerta);
            return;
        }
        if (new String(JPasswordSenha.getPassword()).trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Deve ser digitada alguma senha!", "Aviso!", JOptionPane.ERROR_MESSAGE, iconeAlerta);
            return;
        } else {
            ...
            JOptionPane.showMessageDialog(null, "Administrador foi cadastrado com sucesso!", "Sucesso!", JOptionPane.ERROR_MESSAGE, iconeCerto);
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameCadastroAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameCadastroAdmin().setVisible(true);
            }
        });
    }
