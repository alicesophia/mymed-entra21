 ...
 *
 */
public class JFrameCadastroFarmacia extends javax.swing.JFrame {
    ...
    /**
     * Creates new form JFrameCadastroFarmacia
     */
    public JFrameCadastroFarmacia() {
        initComponents();
        popularCidade();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Cadastrar Farmácia");
    ...
    private void JButtonConcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JButtonConcluirActionPerformed
        if (JComboBoxCidade.getSelectedIndex() == -1) {
            JOptionPane.showMessageDialog(null, "Deve ser selecionado alguma cidade!!!", "Aviso", JOptionPane.ERROR_MESSAGE, iconeAlerta);
            return;
        }
        ...
        if (JTextFieldLogradouro.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Deve ser digitado algo em logradouro!!!", "Aviso", JOptionPane.ERROR_MESSAGE, iconeAlerta);
            return;
        }
        if (JTextFieldTelefone.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Deve ser digitado algo em telefone!!!", "Aviso", JOptionPane.ERROR_MESSAGE, iconeAlerta);
            return;
        }
        if (JTextFieldWebSIte.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Deve ser digitado website!!!", "Aviso", JOptionPane.ERROR_MESSAGE, iconeAlerta);
            return;
        } else {
            ...
            JOptionPane.showMessageDialog(null, "Farmácia foi cadastrada com sucesso!!!", "Aviso", JOptionPane.ERROR_MESSAGE, iconeCerto);
            dispose();
        }
    ...
    public void popularCidade() {
        ArrayList<Cidade> cidades = (ArrayList) CidadeDAO.retornarCidades();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameCadastroFarmacia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameCadastroFarmacia().setVisible(true);
            }
        });
    }
